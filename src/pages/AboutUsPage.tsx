...
import { Target, Eye, Users, Award, CheckCircle, ArrowRight, Globe, Heart, Zap, Shield, Compass, Handshake, Network } from 'lucide-react';
  ...
  const valores = [
    {
      ...
      description: 'Creemos en soluciones simples y aplicables, pero sin caer en fórmulas mágicas. Adaptamos, probamos y luego estandarizamos.',
    ...
    },
    {
      ...
      description: 'Trabajamos con los equipos, no sobre ellos. Nos comprometemos con los problemas y los resultados, caminando al lado del cliente.',
    ...
    },
    {
      ...
      description: 'El orden y la constancia son la base de la mejora. Ayudamos a construir hábitos, no solo a resolver urgencias.',
    ...
    },
    {
      ...
      description: 'Aplicamos herramientas estadísticas y de gestión con fundamento, pero siempre con sentido común y foco en la utilidad.',
    ...
    },
    {
      ...
      description: 'Miramos los procesos completos, desde el origen hasta el cliente final. Aportamos valor donde otros solo ven silos.',
    ...
    },
    {
      ...
      description: 'Creemos que los verdaderos cambios vienen del propio equipo. Nuestro rol es acompañar, no reemplazar.',
    ...
    },
    {
      ...
      description: 'Valoramos la integración entre personas de distintas regiones, culturas y funciones. La diversidad es una fuente clave de ideas, entendimiento y soluciones más completas.',
      color: 'from-[var(--color-secondary)] to-[var(--color-accent)]'
    }
  ];
    ...
    <div className="min-h-screen" style={{ backgroundColor: 'var(--color-bg)' }}>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-[var(--color-primary)] via-[var(--color-secondary)] to-[var(--color-accent)]">
          ...
          <div className="absolute top-1/2 right-1/3 w-32 h-32 bg-white/5 transform rotate-45 animate-spin" style={{ animationDuration: '20s' }}></div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="flex items-center mb-6">
                ...
                <h2 className="text-4xl font-bold text-[var(--color-primary)]">Misión</h2>
              </div>
              ...
              <div className="bg-gradient-to-br from-[var(--color-bg)] to-white rounded-2xl p-8 shadow-xl border border-[var(--color-border)]">
                <div className="grid grid-cols-2 gap-6">
                  <div className="text-center">
                    ...
                    <h4 className="font-bold text-[var(--color-primary)] mb-2">Personalizado</h4>
                    <p className="text-sm text-[var(--color-text)]">Adaptado a cada cliente</p>
                  </div>
                  <div className="text-center">
                    <div className="w-12 h-12 bg-[var(--color-accent)] rounded-full flex items-center justify-center mx-auto mb-3">
                      <ArrowRight className="w-6 h-6 text-white" />
                    </div>
                    <h4 className="font-bold text-[var(--color-primary)] mb-2">End-to-End</h4>
                    <p className="text-sm text-[var(--color-text)]">Cadena completa</p>
                  </div>
                  <div className="text-center">
                    <div className="w-12 h-12 bg-[var(--color-primary)] rounded-full flex items-center justify-center mx-auto mb-3">
                      <Shield className="w-6 h-6 text-white" />
                    </div>
                    <h4 className="font-bold text-[var(--color-primary)] mb-2">Disciplina</h4>
                    <p className="text-sm text-[var(--color-text)]">Operacional sólida</p>
                  </div>
                  <div className="text-center">
                    <div className="w-12 h-12 bg-[var(--color-secondary)] rounded-full flex items-center justify-center mx-auto mb-3">
                      <Award className="w-6 h-6 text-white" />
                    </div>
                    <h4 className="font-bold text-[var(--color-primary)] mb-2">Valor</h4>
                    <p className="text-sm text-[var(--color-text)]">Sostenible y real</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 lg:order-2">
              <div className="flex items-center mb-6">
                ...
                <h2 className="text-4xl font-bold text-[var(--color-primary)]">Visión</h2>
              </div>
              <div className="space-y-6 text-lg text-[var(--color-text)] leading-relaxed">
                <p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {valores.map((valor) => {
              ...
              return (
                ...
                >
                  {/* Icon */}
                  <div className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${valor.color} flex items-center justify-center mb-6 transition-transform duration-300 ${
                    isActive ? 'scale-110' : ''
                  }`}>
                  ...
                  <div className={`absolute top-4 right-4 w-3 h-3 rounded-full transition-all duration-300 ${
                    isActive ? 'bg-[var(--color-secondary)] scale-100' : 'bg-[var(--color-border)] scale-75'
                  }`}></div>
                </div>
              );
            })}
