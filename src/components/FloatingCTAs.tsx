  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Outer pulse ring */}
        <span className="absolute inset-0 rounded-full bg-[#25D366] animate-ping opacity-20 scale-110"></span>

        {/* Hover pulse effect */}
        <span className="absolute inset-0 rounded-full bg-[#25D366]/30 opacity-0 group-hover:opacity-40 transition-opacity duration-300 scale-110"></span>

        {/* Inner glow effect */}
        <span className="absolute inset-1 rounded-full bg-white/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></span>
      </a>
