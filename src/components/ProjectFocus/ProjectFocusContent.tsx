...
import PhasesProjectFocusGraphic from "../../icons-components/ProjectFocus/PhasesProjectFocusGraphic";
import ConnectionProjectFocusGraphic from "../../icons-components/ProjectFocus/ConnectionProjectFocusGraphic";
  ...
  return (
    <div id="ProjectFocus-content" className="bg-[var(--color-bg)]">
      ...
      <ProgramModal
        ...
        closeModalLabel={MODAL_CLOSE_LABEL[currentLanguage as Language]}
      />
    </div>
  );
};
