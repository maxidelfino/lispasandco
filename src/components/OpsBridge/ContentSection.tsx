    ...
    features: [
      ...
      },
      {
        ...
        details: [
          ...
          "Capacitación en reducción de desperdicios, Six Sigma y resolución de problemas in company (en el lugar, no virtual) como introducción al mundo de la mejora continua",
      ...
      },
      {
        ...
        description:
          "OpsBridge™ tiene relación con todos los demás productos de LYSPAS & CO buscando profundizar cada concepto o técnica ya desarrollada. Igualmente la metodología de implementación permite abordar algunos temas desde cero.",
        relatedProducts: [
          {
            icon: Trash2,
            title: "WasteZero™",
