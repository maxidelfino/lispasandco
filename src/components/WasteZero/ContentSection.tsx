...
// Traducciones para RoadmapGraphic
const roadmapLabels: Record<
  Language,
  {
    problemas: string;
    recurrentes: string;
...
const RoadmapGraphic = ({ currentLanguage }: { currentLanguage: Language }) => {
  const labels = roadmapLabels[currentLanguage];
  return (
      ...
      <div className="relative">
        ...
        <div className="flex items-center space-x-8">
          ...
          <div className="text-center">
            ...
            <p className="text-xs text-[var(--color-text)]">{labels.cultura}</p>
            <p className="text-xs text-[var(--color-text)]">{labels.mejora}</p>
          </div>
        </div>
      </div>
    </div>
  ...
  es: {
    features: [
      ...
      },
      {
        ...
        graphic: (
          <RoadmapGraphic currentLanguage={useLanguage().currentLanguage} />
        ),
        details: [
  ...
  en: {
    features: [
      ...
      },
      {
        ...
        subtitle: "6 months implementation",
        description:
          "6-month program combining practical technical training, DMAIC cycle application, and improvement project development, with continuous follow-up and management audits.",
      ...
      },
      {
        ...
        details: [
          ...
          "Teams working hard but feeling they are not achieving expected results",
          "Companies needing to establish a culture of continuous improvement from scratch",
          "Organizations wanting to prepare their staff for Lean certifications",
        ],
      },
      {
        id: "5",
...
const WasteZeroContent: React.FC = () => {
  ...
  const { features, clickForDetails } =
    translations[currentLanguage as Language];
