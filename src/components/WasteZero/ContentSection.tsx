      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            description: "Teams that work hard but not with focus.",
          },
          {
            icon: RefreshCcw,
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            description:
              "Perda de recursos por processos desnecessários, movimentos mal desenhados ou tempos mortos.",
          },
          {
            icon: Users,
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            description:
              "Minimização de tempos mortos e esperas por meio da melhoria na sincronização dos processos.",
          },
          {
            icon: Lightbulb,
