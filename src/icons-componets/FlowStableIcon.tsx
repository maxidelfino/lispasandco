import { TrendingUp, BarChart3, Target, Zap, CheckCircle, Activity } from "lucide-react"

const FlowStableIcon = () => {
  const flowElements = [
    { icon: Target, title: "ESTABILIDAD", color: "bg-blue-500" },
    { icon: BarChart3, title: "MÉTRICAS", color: "bg-[var(--color-secondary)]" },
      ...
      {flowElements.map((element, index) => {
        ...
        return (
          ...
          >
            ...
            <div className="text-[8px] text-center leading-tight">{element.title}</div>
          </div>
        )
      })}
